...
urllist=$(
          curl -s https://incredinews.github.io/feed-sources/raw/lang/de.rss.json|grep "http"|cut -d'"' -f2;
          curl -s https://incredinews.github.io/feed-sources/raw/lang/en.rss.json|grep "http"|cut -d'"' -f2
          )
